...
const char* ssid     = "younes"; //enter your ssid/ wi-fi(case sensitiv) router name - 2.4 Ghz only
const char* password = "70095092y";     // enter ssid password (case sensitiv)
char host[] = "https://googlehomepfe.herokuapp.com/"; //enter your Heroku domain name like "espiot.herokuapp.com" 
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
